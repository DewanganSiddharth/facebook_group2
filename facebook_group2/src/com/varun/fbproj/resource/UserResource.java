...
public class UserResource {
    ...
    public ArrayList<Group> addUser1(User user) throws JsonParseException, JsonMappingException, IOException{
		
		System.out.println("Inside final touch resource");
		System.out.println("my user id is:  = "+user.getUserID());
		//String output = "POST:Jersey say : " + msg;
		ArrayList<Group> ulist = new ArrayList<Group>();
		ulist = EventService.getfriendsfinal(user.getUserID());
