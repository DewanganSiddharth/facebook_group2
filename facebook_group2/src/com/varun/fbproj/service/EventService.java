...
public class EventService {
	...
	public static ArrayList<Group> getfriendsfinal(int uid) // give all eventDetail for particular user 
	{
		ArrayList<Group> ael=new ArrayList<Group>();
		...
		try {
            ...
            while(check==false)
            {
            	...
            	System.out.println("trying connection for Event service");
            		...
            		User u_obj=new User();
					String emailid = RetriveService.emailIDfromuID(uid);
					String q1 = "select group_name from Group1 where owner=?";
					PreparedStatement ps1 = connect.con.prepareStatement(q1);  
			         ...
			         while(result1.next()){
			        	 ...
			        	 System.out.println("-------------------------------------------"+result1.getString("group_name"));
			        	 Group g1 = new Group();
			        	
			        	 g1.setGroup_name(result1.getString("group_name"));
			        	ael.add(g1);
			        	 
			         }
			        // System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++"+groupal);
	...
	public static ArrayList<Event> searchnecessaryevents(int luid,int fuid) // give all eventDetail for particular user 
	{
		...
		try {
         ...
         String q = "select eID from Event where userID=?";
         PreparedStatement ps = connect.con.prepareStatement(q);  
         ps.setInt(1,luid) ;  
         ResultSet result = ps.executeQuery();
				...
				while (result.next()) {
					...
					String q2 ="select eID from EventUserlist where eID=? and userID=? and status=?";
					PreparedStatement ps2 = connect.con.prepareStatement(q2);  
			         ps2.setInt(1,result.getInt("eID")) ;
			         ps2.setInt(2,fuid) ;
			         ps2.setString(3,"Accepted") ;
			         ResultSet result2 = ps2.executeQuery();
					while(result2.next()){
						
						String q3 = "select * from Event where eID=?";
						PreparedStatement ps3 = connect.con.prepareStatement(q3);  
				         ps3.setInt(1,result2.getInt("eID")) ;  
				         ResultSet result3 = ps3.executeQuery();
				         while(result3.next()){
				        	 //System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
				        	 Event e1 = new Event();
				        	 e1.seteID(result3.getInt("eID"));
				        	 e1.setuID(result3.getInt("userID"));
				        	 e1.setHname(result3.getString("hname"));
				        	 e1.setLocation(result3.getString("location"));
				        	 e1.setEname(result3.getString("ename"));
				        	 ael.add(e1);
				         }
				 ...
				 String q5 = "select eID from Event where userID=?";
		         PreparedStatement ps5 = connect.con.prepareStatement(q5);  
		         ps5.setInt(1,fuid) ;  
		         ResultSet result5 = ps5.executeQuery();
						...
						while (result5.next()) {
							...
							String q25 ="select eID from EventUserlist where eID=? and userID=? and status=?";
							PreparedStatement ps25 = connect.con.prepareStatement(q25);  
					         ps25.setInt(1,result5.getInt("eID")) ;
					         ps25.setInt(2,luid) ;
					         ps25.setString(3,"Accepted") ;
					         ResultSet result25 = ps25.executeQuery();
							while(result25.next()){
								
								String q35 = "select * from Event where eID=?";
								PreparedStatement ps35 = connect.con.prepareStatement(q35);  
						         ps35.setInt(1,result25.getInt("eID")) ;  
						         ResultSet result35 = ps35.executeQuery();
						         while(result35.next()){
						        	 //System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
						        	 Event e1 = new Event();
						        	 e1.seteID(result35.getInt("eID"));
						        	 e1.setuID(result35.getInt("userID"));
						        	 e1.setHname(result35.getString("hname"));
						        	 e1.setLocation(result35.getString("location"));
						        	 e1.setEname(result35.getString("ename"));
						        	 ael.add(e1);
						         }
						 ...
						 String q58 = "select eID from EventUserlist where userID=? and status=?";
				         PreparedStatement ps58 = connect.con.prepareStatement(q58);  
				         ps58.setInt(1,luid) ;
				         ps58.setString(2,"Accepted");
				         ResultSet result58 = ps58.executeQuery();
				         
				         while(result58.next()){
				        	 
				        	 String q588 ="select eID from EventUserlist where eID=? and userID=? and status=?";
								PreparedStatement ps588 = connect.con.prepareStatement(q588);  
						         ps588.setInt(1,result58.getInt("eID")) ;
						         ps588.setInt(2,fuid) ;
						         ps588.setString(3,"Accepted") ;
						         ResultSet result588 = ps588.executeQuery();
						         
						         while(result588.next()){
						        	 
						        	 String q358 = "select * from Event where eID=?";
										PreparedStatement ps358 = connect.con.prepareStatement(q358);  
								         ps358.setInt(1,result588.getInt("eID")) ;  
								         ResultSet result358 = ps358.executeQuery();
								         while(result358.next()){
								        	 //System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
								        	 Event e1 = new Event();
								        	 e1.seteID(result358.getInt("eID"));
								        	 e1.setuID(result358.getInt("userID"));
								        	 e1.setHname(result358.getString("hname"));
								        	 e1.setLocation(result358.getString("location"));
								        	 e1.setEname(result358.getString("ename"));
								        	 ael.add(e1);
								         }
	...
	public static ArrayList<User> getfriends(String myEmailID,int eid) // give all eventDetail for particular user 
	{
		ArrayList<User> ael=new ArrayList<User>();
		...
		try {
            ...
            int loginuid=RetriveService.uidfromEmailID(myEmailID); 
            
            
            
            
         String q = "select userID from EventUserlist where eID=? and status=? union select userID from Event where eID=?";
         PreparedStatement ps = connect.con.prepareStatement(q);  
         ps.setInt(1,eid) ;  
         ...
         ResultSet result = ps.executeQuery();
				...
				while (result.next()) {
					 ...
					 User u_obj=new User();
					String emailid = RetriveService.emailIDfromuID(result.getInt("userID"));
					String q1 = "select group_name from Group1 where owner=?";
					PreparedStatement ps1 = connect.con.prepareStatement(q1);  
			         ps1.setString(1,emailid) ;  
			         ResultSet result1 = ps1.executeQuery();
			         ...
			         ArrayList<Group> groupal = new ArrayList<Group>(); 
			        ...
			        // System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++"+groupal);
			         u_obj=RetriveService.getUserAllData(emailid);
			         u_obj.setG(groupal);
	...
	public static ArrayList<Event> searchnecessary(int luid,int fuid) // give all eventDetail for particular user 
	{
		ArrayList<Event> ael=new ArrayList<Event>();
          ...
          ps.setInt(1,eID);
			...
			if(result.next())
			{
				...
				eobj.setEvent_date(result.getString(6));
				 eobj.setEvent_end_date(result.getString(8));
 ...
 java.util.Date date = new java.util.Date();
			...
			while(result.next())
			{
				...
				if (result != null) {
					...
					query = "select userID from Event where eventType=? and userID <> ?";
				PreparedStatement	ps1 = connect.con.prepareStatement(query);
				     ...
				     ArrayList<User> al_friends=new ArrayList<User>();
			          String myEmailID=RetriveService.emailIDfromuID(userID);
			al_friends=GetMyAllFriends.getMyFriends(al_friends,myEmailID);
			  ArrayList<User> al_friends1=new ArrayList<User>();
				     ...
				     { 
				    	 int id=al_friends.get(i).getUserID();
				    	 int flag=0;   
				     	while(rs2.next())
				     	{
			            ...
			            if(flag==1){
			            	al_friends1.add(al_friends.get(i));
			            }
			            rs2.beforeFirst();
				     }
					...
					for(int i=0;i<al_friends1.size();i++){
						 ...
						 query = "select * from Event where eventType=? and userID=?";
					      ps1 = connect.con.prepareStatement(query);
					     ps1.setString(1,"Public");
					     ps1.setInt(2,al_friends1.get(i).getUserID());
